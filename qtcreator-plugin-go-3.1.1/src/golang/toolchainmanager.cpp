...
static const char TOOLCHAIN_DATA_KEY[] = "GoToolChain.";
static const char TOOLCHAIN_COUNT_KEY[] = "GoToolChain.Count";
static const char TOOLCHAIN_FILE_VERSION_KEY[] = "Version";
static const char TOOLCHAIN_FILENAME[] = "/qtcreator/gotoolchains.xml";
    ...
    QObject(parent)
{
    ...
    connect(this, SIGNAL(toolChainAdded(GoLang::ToolChain*)),
            this, SIGNAL(toolChainsChanged()));
    connect(this, SIGNAL(toolChainRemoved(GoLang::ToolChain*)),
            this, SIGNAL(toolChainsChanged()));
    connect(this, SIGNAL(toolChainUpdated(GoLang::ToolChain*)),
            this, SIGNAL(toolChainsChanged()));
}
...
QList<ToolChain *> ToolChainManager::findToolChains(const ProjectExplorer::Abi &abi)
{
    QList<ToolChain *> result;
    foreach (ToolChain *tc, d->m_toolChains) {
