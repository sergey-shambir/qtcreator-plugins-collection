...
**
****************************************************************************/
#ifndef GOLANG_INTERNAL_TOOLCHAINOPTIONSPAGE_H
#define GOLANG_INTERNAL_TOOLCHAINOPTIONSPAGE_H
...
private slots:
    void addToolChain(ToolChain *);
    void removeToolChain(ToolChain *);
    void setDirty();
...
#endif // GOLANG_INTERNAL_TOOLCHAINOPTIONSPAGE_H
